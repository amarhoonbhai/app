            ...
            for msg in messages:
                ...
                for group in groups:
                    try:
                        ...
                        print(f"[{phone}] Forwarded to {group}")                    except Exception as e:
                        print(f"[{phone}] Error: {e}")
                await asyncio.sleep(user_state["delay"])

            print(f"[{phone}] Cycle complete. Sleeping for {user_state['cycle']} minutes...")            await asyncio.sleep(user_state["cycle"] * 60)
